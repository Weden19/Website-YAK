...
const RULES_SLIDES = [
    ...
    blocks: [
      {
        ...
        items: [
          ...
          'Шевроны должны быть читаемыми – не скрыты мехом',
          'Большие хвосты рекомендуется скрывать в тандемных кабинах самолётов',
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'image', src: 'assets/rules/chevron-scheme.png', alt: 'Схема шевронов из Приказа №102-р' },
      {
        type: 'text',
